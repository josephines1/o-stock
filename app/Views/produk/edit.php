                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 w-100">
                                ...
                                <input name="kode_produk" type="text" class="form-control <?= validation_show_error('kode_produk') ? 'is-invalid' : '' ?>" placeholder="e.g. MTB0101" value="<?= old('kode_produk', htmlspecialchars($db['kode_produk'])) ?>">
                            ...
                            <div class="mb-3 w-100">
                                ...
                                <input name="nama" type="text" class="form-control <?= validation_show_error('nama') ? 'is-invalid' : '' ?>" placeholder="e.g. Oli Motor" value="<?= old('nama', htmlspecialchars($db['nama'])) ?>">
                                ...
                                <select name="supplier" id="supplier" type="text" class="form-select <?= validation_show_error('supplier') ? 'is-invalid' : '' ?>">
                                    ...
                                    <?php if (!empty($data_supplier)) : ?>
                                        <?php foreach ($data_supplier as $supplier) : ?>
                                            <option value="<?= $supplier['id'] ?>" <?= old('supplier', $db['id_supplier']) === $supplier['id'] ? 'selected' : '' ?>><?= $supplier['nama'] ?></option>
                                        <?php endforeach; ?>
                                    <?php else : ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 w-100">
                                ...
                                <input name="harga_jual" type="text" class="form-control <?= validation_show_error('harga_jual') ? 'is-invalid' : '' ?>" placeholder="e.g. 150.000" value="<?= old('harga_jual', $db['harga_jual']) ?>">
                                ...
                                <select name="kategori" id="kategori" type="text" class="form-select <?= validation_show_error('kategori') ? 'is-invalid' : '' ?>">
                                    ...
                                    <?php if (!empty($data_kategori)) : ?>
                                        <?php foreach ($data_kategori as $kategori) : ?>
                                            <option value="<?= $kategori['id'] ?>" <?= old('kategori', $db['id_kategori']) === $kategori['id'] ? 'selected' : '' ?>><?= $kategori['nama'] ?></option>
                                        <?php endforeach; ?>
                                    <?php else : ?>
