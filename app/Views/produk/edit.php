                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 w-100">
                                ...
                                <input name="kode_produk" type="text" class="form-control <?= validation_show_error('kode_produk') ? 'is-invalid' : '' ?>" placeholder="Kode Produk" value="<?= old('kode_produk', htmlspecialchars($db['kode_produk'])) ?>">
                            ...
                            <div class="mb-3 w-100">
                                ...
                                <input name="nama" type="text" class="form-control <?= validation_show_error('nama') ? 'is-invalid' : '' ?>" placeholder="Nama Produk" value="<?= old('nama', htmlspecialchars($db['nama'])) ?>">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 w-100">
                                ...
                                <input name="harga_jual" type="text" class="form-control <?= validation_show_error('harga_jual') ? 'is-invalid' : '' ?>" placeholder="Harga Jual" value="<?= old('harga_jual', $db['harga_jual']) ?>">
