        ...
        <div class="row g-2 align-items-center mb-4">
            ...
            <div class="col-md-auto ms-auto mt-4 mt-md-0 d-print-none">
                <div class="d-flex flex-wrap flex-md-nowrap flex-column-reverse flex-md-row">
                    <input id="keyword" value="<?= $filter_k ?>" type="search" class="form-control d-inline-block w-9 me-0 mb-md-0 mb-3" placeholder="Search cabang">
                    <?php if (in_groups('pusat')) : ?>
                        <a href="<?= base_url("/cabang/new") ?>" class="btn btn-primary ms-0 ms-md-3 mt-3 mt-md-0 mb-md-0 mb-3">
