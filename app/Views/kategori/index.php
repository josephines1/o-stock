        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-muted">
                    <p>Apakah Anda yakin ingin menghapus data kategori <strong><span id="modal-kategori-name" class="text-danger">ini</span></strong>?</p>
                    <p>Data produk yang terdaftar pada kategori ini juga akan terhapus dan data yang sudah terhapus TIDAK DAPAT DIKEMBALIKAN.</p>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $('#keyword').on('keyup', function() {
            $.get('cari-kategori?keyword=' + $('#keyword').val(), function(data) {
        ...
        $('body').on('click', '.btn-hapus', function(e) {
            ...
            $('#modal-kategori-name').html(nama);
            $('#form-hapus').attr('action', '/kategori/' + id);
        });
    })
</script>
<?= $this->endSection() ?>