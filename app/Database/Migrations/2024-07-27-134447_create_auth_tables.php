...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'photo_profile'    => ['type' => 'varchar', 'constraint' => 255, 'default' => 'user.png'],
        ...
        $this->forge->addForeignKey('id_kantor', 'kantor', 'id', 'CASCADE', 'CASCADE');
    ...
    public function down()
    {
        ...
        if ($this->db->DBDriver !== 'SQLite3') { // @phpstan-ignore-line
            $this->forge->dropForeignKey('users', 'users_id_kantor_foreign');
